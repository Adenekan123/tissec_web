        ...
        <section>
            ...
            <section className="-mt-36 relative z-10">
                <div className="bg-zinc-50 text-center md:mx-24 text-sky-950 md:p-8 p-2">
                    <h2 className="md:text-4xl text-3xl pt-12 md:mx-0 mx-4">Why choose a Managed EDR Service?</h2>
                    <div className="md:grid grid-cols-3 md:basis-9/12 md:px-24 px-20 py-10 gap-x-20">
                        <div className="flex flex-col items-center">
                            <button className="text-5xl shadow-xl p-8 hover:bg-amber-400 my-8 hover:text-white"><IoLocateOutline /></button>
                            <p className="text-base">Combining market-leading EDR technology with Falanx Cyber analysts to hunt and remediate threats.</p>
                        </div>
                        <div className="flex flex-col items-center">
                            <button className="text-5xl shadow-xl p-8 hover:bg-amber-400 my-8 hover:text-white"><CiAlarmOn /></button>
                            <p className="text-base">Significantly faster investigation and response.</p>
                        </div>
                        <div className="flex  flex-col items-center">
                            <button className="text-5xl shadow-xl p-8 hover:bg-amber-400 my-8 hover:text-white"><MdOutlineDoNotDisturb /></button>
                            <p className="text-base">Protect user devices against multiple threat vectors.</p>
                        </div>
                    </div>
                </div>
            </section>
            <SectionPoster image={'/images/EMDR-2.jpg'}>
                <div className="flex flex-col md:basis-2/6 text-left md:mr-16 mt-36">
                    ...
                    <div><button className="bg-sky-950 md:px-8 md:py-5 px-5 py-3 text-white hover:bg-amber-400 font-semibold text-base">Request a quote</button></div>
                </div>
            </SectionPoster>
            <section className="text-sky-950">
                <div className="bg-[url('/images/mdr-grey-bg-yellow.jpg')] bg-cover bg-top w-full relative">
                    <div className="pt-24 md:px-16 m-4">
                        <h2 className="md:text-4xl md:my-16 text-3xl my-6">Rapid investigation and immediate intervention</h2>
                        <div className="md:flex md:text-left md:mr-72 md:space-x-10 space-y-6">
                            <div className="space-y-4">
                                <p className="text-base py-3">Our endpoint protection platform includes trade craft protection techniques that cover the MITRE ATT&CK™ Matrix, enabling us to stop targeted attacks at any stage before damage and loss occur</p>
                                <p className="text-base py-3">These points combined drive the Mean Time to Detect (MTTD) and Mean Time to Respond (MTTR) down to a couple of seconds. That, in turn, significantly reduces the cost, time, and effort in dealing with any cyber-attack.</p>
                            </div>
                            <div>
                                <p className="text-base">With average dwell times in excess of 90 days, long-term data retention is key. All data is streamed to Falanx Cyber’s backend SOC infrastructure, where it is retained for up to 1 year for future analysis.</p>
                            </div>
                        </div>
                    ...
                    <div className="md:text-center md:mx-96 my-20 mx-6">
                        <h2 className="md:text-4xl text-2xl">Standard features included in our M-EDR service</h2>
                        <p className="pt-16 text-base">Endpoint protection, security operations, and threat hunting programmes powered by the speed, scalability, and power of Falanx Cyber, Endgame and Elastic.</p>
                    </div>
                    <div className="md:grid grid-cols-2 gap-6 text-sky-950 space-y-2 md:mx-24 md:my-10 mx-4 ">
                        <div className="md:space-y-4 space-y-9 ">
                            <div className="flex p-6 md:px-9 hover:bg-sky-950 shadow-lg group">
                                <div className="text-4xl pr-4 group-hover:text-amber-400"><MdOutlineErrorOutline /></div>
                                <div>
                                    <h5 className="text-xl font-semibold group-hover:text-amber-400">Instant action</h5>
                                    <p className="py-4 group-hover:text-white text-base">Enjoy the comfort of knowing that your infrastructure is being constantly monitored and, in the event of suspicious activity, action will be taken to isolate the offending item before it can do harm.</p>
                                </div>
                            </div>

                            <div className="flex p-6 hover:bg-sky-950 shadow-lg group">
                                <div className="text-4xl pr-4 group-hover:text-amber-400"><ImConnection /></div>
                                <div>
                                    <h5 className="text-xl font-semibold group-hover:text-amber-400">Online & offline</h5>
                                    <p className="py-4 group-hover:text-white text-base">Whether staff are on or offline, in the office or working remotely, their endpoints are constantly protected.</p>
                                </div>
                            </div>

                            <div className="flex p-6 hover:bg-sky-950 shadow-lg group">
                                <div className="text-4xl pr-4 group-hover:text-amber-400"><VscTools /></div>
                                <div>
                                    <h5 className="text-xl font-semibold group-hover:text-amber-400">Simple, lightweight, yet powerful</h5>
                                    <p className="py-4 group-hover:text-white text-base">Our lightweight agent consumes minimal system resources, typically less than 1%, whilst offering next-generation cyber protection.</p>
                                </div>
                            </div>
                        </div>
                        <div className="md:py-16 space-y-4 py-4">
                            <div className="group">
                                <div className="flex p-6 group-hover:bg-sky-950 shadow-lg">
                                    <div className="text-4xl pr-4 group-hover:text-amber-400"><BsClock /></div>
                                    <div>
                                        <h5 className="text-xl font-semibold group-hover:text-amber-400">24x7x365 Service</h5>
                                        <p className="py-4 group-hover:text-white text-base">Protection any time, day or night, including weekends and bank holidays. Clients can rest easy when away from work, safe in the knowledge that if anything happens, we are watching from our UK SOC.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="group">
                                <div className="flex p-6 group-hover:bg-sky-950 shadow-lg">
                                    <div className="text-4xl pr-4 group-hover:text-amber-400"><MdOutlineDoNotDisturb /></div>
                                    <div>
                                        <h5 className="text-xl font-semibold group-hover:text-amber-400">Prevent to protect</h5>
                                        <p className="py-4 group-hover:text-white text-base">We look for signs of intrusion and prevent malicious code from being executed, protecting you from zero-day attacks.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="group">
                                <div className="flex p-6 group-hover:bg-sky-950 shadow-lg">
                                    <div className="text-4xl pr-4 group-hover:text-amber-400"><IoSettingsOutline /></div>
                                    <div>
                                        <h5 className="text-xl font-semibold group-hover:text-amber-400">Defence against APT attackers</h5>
                                        <p className="py-4 group-hover:text-white text-base">Our M-EDR solution has been independently evaluated against the tactics, techniques, and procedures of two major Advanced Persistent Threat (APT) campaigns.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="md:-mt-24">
                <div className="bg-sky-950 py-7 text-white">
                    <h2 className="md:text-5xl text-center text-3xl mt-24">Full feature list</h2>
